...
<div class="custom-jumbotron">
    ...
    <div class=" p-5 mb-4  text-bg-dark rounded-3 ">
        <div class="container-fluid py-5">
            <h1 class="display-5 fw-bold">Donate here....</h1>
            <p class="col-md-8 fs-4">You can help people by donating to us.</p>
            <hr class="my-4">

            <div class="">
                <form action="/donation/partials/_handleDonar.php" method="post">

                    <div class="mb-3">
                        <label for="Title" class="form-label">Donation Title</label>
                        <input type="text" class="form-control" id="donarTitile" name="donarTitle"
                            placeholder="Enter you donation Subject" required>
                    </div>

                    <div class="mb-3">
                        <label for="donationType" class="form-label">Donation Type</label>
                        <select class="form-select" id="dType" name="dType" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="donarAmount" name="donarAmount"
                            placeholder="Enter amount or description of donation" required>
                    </div>

                    <div class="mb-3">
                        <label for="donorMessage" class="form-label">Message</label>
                        <textarea class="form-control" id="dMessage" name="dMessage" rows="4"
